...
const AsideLeft = () => {
    ...
    <aside className='min-h-[100vh] max-w-[300px]'>
        ...
        <div className={`${isOpen ? "left-0" : "left-[-120%]"} bg-[#1f1e22] md:bg-inherit fixed min-h-[100%] z-49  sidenav p-16 pt-12 md:sticky md:min-h-[100vh] top-0 min-w-[260px] flex justify-between flex-col`}>
            <h1 className='text-5xl font-bold hover:text-blue-400 border-b-[3px] pb-4 border-blue-400 text-white'>
                <Link href={"/"}>
            Lucas
                 <p className='ml-10'>
            Diello
            ...
            <ul className='font-oswald space-y-5 text-xl tracking-widest font-light text-white' >
