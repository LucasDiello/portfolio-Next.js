...
export const projectsBackEnd : ProjectBackEnd[] = [
    {
      "title": "Visualize já",
      "description": "API RESTfull para um sistema de imóveis, com validações de dados, autenticação de usuários, cadastro de imóveis, listagem de imóveis, busca de imóveis por filtros, negociação com proprietários entre outras funcionalidades.",
      "techs": ["Node.js", "Oauth", "NodeMailer", "MongoDB", "Express", "Node.js", "JWT", "Prisma", "Socket.io"],
      "github": "https://github.com/LucasDiello/full-stack-hosting",
      "descriptionEn":"RESTful API for a real estate system, with data validation, user authentication, property registration, property listing, property search by filters, among other features."
    },
    {
      "title": "D&D Game",
      "description": "Um jogo simples de RPG de mesa. Utilizando POO com typescript, foi possível criar um sistema de personagens, itens, monstros magias e ataques onde o usuário pode duelar com os monstros.",
      "techs": ["Node.js", "Express", "TypeScript", "POO", "SOLID"],
    ...
    {
      "title": "Store Manager",
      "description": "Esta é uma api RESTfull desenvolvida para gerenciar operações em um sistema de estoque e vendas, utilizando o banco de dados MySQL para a gestão de dados.",
      techs: ["Node.js", "Express", "MySQL", "Joi Schemas", "sinon", "mocha", "Dockerfile"],
    ...
    {
      "title": "JWT SMITH",
      "description": "Sistema de gerenciamento de pedidos e produtos, com funcionalidades como cadastro e listagem de produtos, listagem de pedidos, login de usuários, validações de produtos e validaçao com JWT.",
      techs: ["Node.js", "Express", "JWT", "MySQL", "Sequelize", "sinon", "mocha"],
    ...
    },
    {
      ...
      "techs": ["Node.js", "Express", "JWT", "MySQL", "Sequelize", "Joi Schemas"],
    ...
    },
    {
      ...
      "description": "Sistema para gerenciamento de jogos de futebol, com funcionalidades como cadastro e listagem de jogos, listagem d times, login de usuários, validação de Token JWT e até mesmo a possibilidade de cadastro de jogos com validação de token JWT.",
      techs: ["Node.js", "Express", "JWT", "MySQL", "Sequelize", "Joi Schemas", "railway deploy"],
    ...
    },
    {
      ...
      "description": "  Sistema utilizando Docker para gerenciamento de tarefas, com funcionalidades como listagem de tarefas...",
      techs: ["Node.js", "files", "Docker", "Express"],
